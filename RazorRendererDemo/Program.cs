...
if (true)
{
    ...
    JS.Set("_marray121", array);
    var cnt = 10000;
    var callsPerIteration = 2;
    for (var i = 0; i < cnt; i++)
    {
        using var window2 = JS.Get<SpawnJSObject>("window");
        array.Set(i, window2);
    }
...
builder.RootComponents.AddSharedStyleSheet("css/app.css", "RazorRendererDemo.styles.css");
